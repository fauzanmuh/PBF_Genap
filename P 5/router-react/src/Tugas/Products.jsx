...
function Popular() {
    return (
        <div className="row">
            <Item number="product-1" name="Sepatu" price="350.000" image="https://source.unsplash.com/random/300x300/?shoe" />
...
function Random() {
    return (
        <div className="row">
            <Item number="product-1" name="Handphone" price="3.000.000" image="https://source.unsplash.com/random/300x300/?handphone" />
            <Item number="product-2" name="Laptop" price="16.000.000" image="https://source.unsplash.com/random/300x300/?laptop" />
            <Item number="product-3" name="Topi" price="350.000" image="https://source.unsplash.com/random/300x300/?hat" />
            <Item number="product-4" name="Celana" price="350.000" image="https://source.unsplash.com/random/300x300/?trouser" />
        </div>
    )
}
