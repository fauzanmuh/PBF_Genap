    ...
    <div className="container">
      ...
      <div className="row mt-3 mb-5">
        <div className="col-md-8 col-sm-6" style={{ color: "#5a606b" }}>
          <h3>ABOUT ME</h3>
          <p>
            Hi, My name is Muhammad Fauzan, you can call me Fauzan. Im Currently study at Malang State Polytechinc
            Majoring Informatic Engineering.
          </p>
